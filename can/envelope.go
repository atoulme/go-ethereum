...
// Contains the Canto protocol Envelope element.

package canto

// Envelope represents a clear-text data packet to transmit through the Canto
...
// 	pow float64 // Message-specific PoW as described in the canto specification.
...
// // NewEnvelope wraps a Canto message with expiration and destination data
...
// func (c *Canto) GetEnvelope(hash common.Hash) *Envelope {
// 	c.poolMu.RLock()
