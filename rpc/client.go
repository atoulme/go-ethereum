...
// CanSubscribe registers a subscripion under the "can" namespace.
func (c *Client) CanSubscribe(ctx context.Context, channel interface{}, args ...interface{}) (*ClientSubscription, error) {
